...
def extract_and_load(extract_cursor,data_source,source_id,load_cursor):
...
extract_and_load(cursor,'ticketmaster','ticketmaster_id',cursor2)
...
extract_and_load(cursor3,'eventbrite','eventbrite_id',cursor4)
