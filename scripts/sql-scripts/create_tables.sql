...
CREATE TABLE IF NOT EXISTS `state_of_music`.`all_events` (
  ...
  `electronic` DECIMAL(3,2) NULL,
  `country_and_folk` DECIMAL(3,2) NULL,
  `assigned_genre` VARCHAR(25) NULL,
  PRIMARY KEY (`id`));

CREATE TABLE IF NOT EXISTS `state_of_music`.`final_data` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `state_code` INT(3) NULL,
  `state_name` VARCHAR(50) NULL,
  `state_abbr` VARCHAR(2) NULL,
  ...
  `hip_hop` INT NULL,
  `rnb` INT NULL,
  `classical_and_jazz` INT NULL,
  `electronic` INT NULL,
  `country_and_folk` INT NULL,
  `assigned_genre` VARCHAR(25) NULL,
  `pop_norm` DECIMAL(3,2) NULL,
  `rock_norm` DECIMAL(3,2) NULL,
  `hip_hop_norm` DECIMAL(3,2) NULL,
  `rnb_norm` DECIMAL(3,2) NULL,
  `classical_and_jazz_norm` DECIMAL(3,2) NULL,
  `electronic_norm` DECIMAL(3,2) NULL,
  `country_and_folk_norm` DECIMAL(3,2) NULL,
  PRIMARY KEY (`id`));